...
function ModPhysics:setSpeedModifier(modX,modY)
	modY = modY or modX
...
function ModPhysics:move( dt, body, forceX, forceY, isMovingX,isMovingY)
...
function ModPhysics:postCollide( other, collision )
	lume.trace()
end
